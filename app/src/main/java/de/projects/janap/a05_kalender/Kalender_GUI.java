...
public class Kalender_GUI extends AppCompatActivity {
    ...
    private FloatingActionButton neuerTermin;
    ...
    public FloatingActionButton getNeuerTermin(){return neuerTermin;}
    ...
    private void initialisieren(){
        ...
        neuerTermin = findViewById(R.id.btn_neuerTermin);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strg.ladeDaten();
        strg.aktualisiereTerminListView(strg.getTermineDesTages());
